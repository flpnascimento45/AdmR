...
<html>
    <head>
      ...
      <title>Romanza - Fornecedores</title>
    ...
    <body>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Fornecedor</h5>
        ...
        <script src="index_fornecedor.js"></script>

        <?php
            validaUsuario('Fornecedor', true);
        ?>
