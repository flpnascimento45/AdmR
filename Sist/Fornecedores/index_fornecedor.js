...
function consultarFornecedor(){
    ...
    if (pessoaSelecionada.length <= 0 || pessoaSelecionada <= 0){
        modalOk(function(){}, 'Id do fornecedor não identificado!');
    } else {
    ...
    $.ajax({         
        ...
        success: function(dados){
            ...
            if (dados[0] == 'Ok'){
                ...
                toastMensagem(dados[1], 'Fornecedor', '#30eb73');
                consultarFornecedor();
                listaPessoa();
            } else {
                modalOk(function(){}, dados[1]);
...
$(document).ready(function(){
    ...
    $("#tituloAplicacao").html('Fornecedores ' + $("#tituloAplicacao").html());
