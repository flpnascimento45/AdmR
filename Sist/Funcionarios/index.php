...
<html>
    <head>
      ...
      <title>Romanza - Funcionários</title>
    ...
    <body>
                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5">
                                    <label for="pessoaFantasia">Nome</label>
                                    <input type="text" maxlength="100" class="form-control" id="pessoaFantasia" placeholder="Nome">
                                </div>
                                <div class="form-group col-md-5">
                                    <label for="pessoaCpfCnpj">Cpf</label>
                                    <input type="text" maxlength="14" class="form-control maskcpf" id="pessoaCpfCnpj" placeholder="Cpf">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="pessoaValCred">Valor Crédito</label>
                                    <input type="text" class="form-control maskdinheironeg" id="pessoaValCred" placeholder="Valor Crédito">
                                </div>
                                <div class="form-group col-md-2">
                            ...
                            <div class="form-row listaDespesas">
        ...
        <?php
            validaUsuario('Funcionario', true);
        ?>
